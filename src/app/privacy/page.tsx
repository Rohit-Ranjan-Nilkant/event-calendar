...
export const metadata = { title: "Privacy Policy – DS EventHub" }
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950">
      ...
      <div className="max-w-5xl mx-auto px-4 py-8">
        ...
        {/* Embedded iframe for the full policy */}
        ...
        <p className="mt-4 text-xs text-gray-400 dark:text-gray-500 text-center">
          View directly at{" "}
          <a href="https://digitalsherpa.ai/privacy-policy/" target="_blank" rel="noopener noreferrer" className="text-indigo-600 hover:underline">
            digitalsherpa.ai/privacy-policy
          </a>
        </p>
      </div>
    </div>
